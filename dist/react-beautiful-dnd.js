...
var position_1 = position.apply;
var position_2 = position.closest;
var position_3 = position.distance;
var position_4 = position.patch;
var position_5 = position.absolute;
var position_6 = position.negate;
var position_7 = position.isEqual;
var position_8 = position.subtract;
var position_9 = position.add;
...
var _memoizeOne2 = _interopRequireDefault(lib$2);
...
var spacing_1 = spacing.offsetByPosition;
var spacing_2 = spacing.expandByPosition;
var spacing_3 = spacing.expandBySpacing;
var spacing_4 = spacing.isEqual;
var spacing_5 = spacing.getCorners;
...
var getMaxScroll = createCommonjsModule(function (module, exports) {
...
exports.default = function (_ref) {
  ...
  var maxScroll = (0, position.subtract)({ x: scrollWidth, y: scrollHeight }, { x: width, y: height });
...
var _getMaxScroll2 = _interopRequireDefault(getMaxScroll);
...
var getDraggableDimension = exports.getDraggableDimension = function getDraggableDimension(_ref) {
  ...
  var withScroll = (0, spacing.offsetByPosition)(client, windowScroll);
  ...
  var dimension = {
    ...
    client: {
      ...
      withMargin: (0, _getArea2.default)((0, spacing.expandBySpacing)(client, margin))
    },

    page: {
      withoutMargin: (0, _getArea2.default)(withScroll),
      withMargin: (0, _getArea2.default)((0, spacing.expandBySpacing)(withScroll, margin))
    }
  };
...
var scrollDroppable = exports.scrollDroppable = function scrollDroppable(droppable, newScroll) {
  ...
  var scrollDiff = (0, position.subtract)(newScroll, existingScrollable.scroll.initial);
  ...
  var displacedSubject = (0, spacing.offsetByPosition)(droppable.viewport.subject, scrollDisplacement);
...
var getDroppableDimension = exports.getDroppableDimension = function getDroppableDimension(_ref2) {
  ...
  var withMargin = (0, spacing.expandBySpacing)(client, margin);
  var withWindowScroll = (0, spacing.offsetByPosition)(client, windowScroll);
  var subject = (0, _getArea2.default)((0, spacing.expandBySpacing)(withWindowScroll, margin));
  ...
  var closestScrollable = function () {
    ...
    var frame = (0, _getArea2.default)((0, spacing.offsetByPosition)(closest.frameClient, windowScroll));
  ...
  var dimension = {
    ...
    client: {
      ...
      withMarginAndPadding: (0, _getArea2.default)((0, spacing.expandBySpacing)(withMargin, padding))
    },
    page: {
      withoutMargin: (0, _getArea2.default)(withWindowScroll),
      withMargin: subject,
      withMarginAndPadding: (0, _getArea2.default)((0, spacing.expandBySpacing)((0, spacing.expandBySpacing)(withWindowScroll, margin), padding))
    },
    viewport: viewport
  };
...
var getWithGrowth = (0, _memoizeOne2.default)(function (area, growth) {
  return (0, _getArea2.default)((0, spacing.expandByPosition)(area, growth));
});
...
var getClippedAreaWithPlaceholder = function getClippedAreaWithPlaceholder(_ref) {
  ...
  return (0, dimension.clip)(closestScrollable.frame, subjectWithGrowth);
};
...
var isPartiallyVisibleThroughFrame = createCommonjsModule(function (module, exports) {
...
unwrapExports(isPartiallyVisibleThroughFrame);

var isTotallyVisibleThroughFrame = createCommonjsModule(function (module, exports) {
...
unwrapExports(isTotallyVisibleThroughFrame);
...
var _isPartiallyVisibleThroughFrame2 = _interopRequireDefault(isPartiallyVisibleThroughFrame);



var _isTotallyVisibleThroughFrame2 = _interopRequireDefault(isTotallyVisibleThroughFrame);
...
var isVisible = function isVisible(_ref) {
  ...
  var withDisplacement = (0, spacing.offsetByPosition)(target, displacement);
...
unwrapExports(isVisible_1);
var isVisible_2 = isVisible_1.isTotallyVisible;
var isVisible_3 = isVisible_1.isPartiallyVisible;
...
exports.default = function (_ref) {
  ...
  var isVisible = (0, isVisible_1.isPartiallyVisible)({
...
var withDroppableScroll = createCommonjsModule(function (module, exports) {
...
exports.default = function (droppable, point) {
  ...
  return (0, position.add)(point, closestScrollable.scroll.diff.value);
};
});

unwrapExports(withDroppableScroll);

var getWindowScroll = createCommonjsModule(function (module, exports) {
...
var _getWindowScroll2 = _interopRequireDefault(getWindowScroll);
...
var _withDroppableScroll2 = _interopRequireDefault(withDroppableScroll);
...
var withDroppableDisplacement = createCommonjsModule(function (module, exports) {
...
exports.default = function (droppable, point) {
  ...
  return (0, position.add)(point, closestScrollable.scroll.diff.displacement);
};
});

unwrapExports(withDroppableDisplacement);

var isTotallyVisibleInNewLocation = createCommonjsModule(function (module, exports) {
...
exports.default = function (_ref) {
  ...
  var diff = (0, position.subtract)(newPageCenter, draggable.page.withoutMargin.center);
  var shifted = (0, spacing.offsetByPosition)(draggable.page.withoutMargin, diff);

  return (0, isVisible_1.isTotallyVisible)({
    target: shifted,
    destination: destination,
    viewport: viewport
  });
...
unwrapExports(isTotallyVisibleInNewLocation);
...
exports.default = function (_ref) {
  ...
  var signed = (0, position.patch)(destinationAxis.line, (sourceEdge === 'end' ? -1 : 1) * centerDiff[destinationAxis.line], centerDiff[destinationAxis.crossAxisLine]);
...
var getForcedDisplacement = createCommonjsModule(function (module, exports) {
...
unwrapExports(getForcedDisplacement);
var getForcedDisplacement_1 = getForcedDisplacement.withFirstRemoved;
var getForcedDisplacement_2 = getForcedDisplacement.withFirstAdded;
...
var _withDroppableDisplacement2 = _interopRequireDefault(withDroppableDisplacement);



var _isTotallyVisibleInNewLocation2 = _interopRequireDefault(isTotallyVisibleInNewLocation);
...
exports.default = function (_ref) {
  ...
  var displaced = function () {
    if (isMovingTowardStart) {
      return (0, getForcedDisplacement.withFirstRemoved)({
    ...
    return (0, getForcedDisplacement.withFirstAdded)({
  ...
  var distance = (0, position.subtract)(newPageCenter, previousPageCenter);
...
exports.default = function (_ref) {
  ...
  var distanceMoving = (0, position.subtract)(newPageCenter, previousPageCenter);
...
exports.default = function (_ref) {
  ...
  var result = insideDestination.filter(function (draggable) {
    ...
    var distanceToA = (0, position.distance)(pageCenter, (0, _withDroppableDisplacement2.default)(destination, a.page.withMargin.center));
    var distanceToB = (0, position.distance)(pageCenter, (0, _withDroppableDisplacement2.default)(destination, b.page.withMargin.center));
...
exports.default = function () {
  ...
  if (action.type === 'PUBLISH_DRAGGABLE_DIMENSION') {
    var dimension$$1 = action.payload;
    ...
    var newState = (0, _extends7.default)({}, state, {
      dimension: {
        ...
        draggable: (0, _extends7.default)({}, state.dimension.draggable, (0, _defineProperty3.default)({}, dimension$$1.descriptor.id, dimension$$1))
      }
    });
  ...
  if (action.type === 'UPDATE_DROPPABLE_DIMENSION_SCROLL') {
    ...
    var _dimension2 = (0, dimension.scrollDroppable)(target, offset);
  ...
  if (action.type === 'MOVE_BY_WINDOW_SCROLL') {
    ...
    if ((0, position.isEqual)(_windowScroll3, _drag3.current.windowScroll)) {
      return state;
    }
...
var _reduxThunk2 = _interopRequireDefault(lib$1);
...
var messagePreset = createCommonjsModule(function (module, exports) {
...
unwrapExports(messagePreset);

var hookCaller = createCommonjsModule(function (module, exports) {
...
var _messagePreset2 = _interopRequireDefault(messagePreset);
...
var scrollWindow = createCommonjsModule(function (module, exports) {
...
unwrapExports(scrollWindow);

var announcer = createCommonjsModule(function (module, exports) {
...
var getBestScrollableDroppable = createCommonjsModule(function (module, exports) {
...
unwrapExports(getBestScrollableDroppable);

var canScroll = createCommonjsModule(function (module, exports) {
...
var smallestSigned = (0, position.apply)(function (value) {
  if (value === 0) {
    return 0;
  }
  return value > 0 ? 1 : -1;
...
var getOverlap = exports.getOverlap = function () {
  ...
  return function (_ref) {
    ...
    var targetScroll = (0, position.add)(current, change);
    ...
    if ((0, position.isEqual)(overlap, origin)) {
      return null;
    }
...
unwrapExports(canScroll);
var canScroll_1 = canScroll.getDroppableOverlap;
var canScroll_2 = canScroll.getWindowOverlap;
var canScroll_3 = canScroll.canScrollDroppable;
var canScroll_4 = canScroll.canScrollWindow;
var canScroll_5 = canScroll.canPartiallyScroll;
var canScroll_6 = canScroll.getOverlap;

var fluidScroller = createCommonjsModule(function (module, exports) {
...
var _getBestScrollableDroppable2 = _interopRequireDefault(getBestScrollableDroppable);
...
var clean = (0, position.apply)(function (value) {
  return value === 0 ? 0 : value;
});

var getPixelThresholds = exports.getPixelThresholds = function getPixelThresholds(container, axis$$1) {
  var startFrom = container[axis$$1.size] * config.startFrom;
  var maxSpeedAt = container[axis$$1.size] * config.maxSpeedAt;
...
var getRequiredScroll = function getRequiredScroll(_ref2) {
  ...
  var y = function () {
    var thresholds = getPixelThresholds(container, axis.vertical);
  ...
  var x = function () {
    var thresholds = getPixelThresholds(container, axis.horizontal);
  ...
  if ((0, position.isEqual)(required, origin)) {
    return null;
  }
  ...
  return (0, position.isEqual)(limited, origin) ? null : limited;
};
...
var withPlaceholder = function withPlaceholder(droppable, draggable) {
  ...
  var spaceForPlaceholder = (0, position.patch)(droppable.axis.line, draggable.placeholder.withoutMargin[droppable.axis.size]);

  var newMax = (0, position.add)(max, spaceForPlaceholder);
...
exports.default = function (_ref3) {
  ...
  var scroller = function scroller(state) {
    ...
    if (requiredWindowScroll && (0, canScroll.canScrollWindow)(requiredWindowScroll)) {
    ...
    var canScrollDroppable = (0, canScroll.canPartiallyScroll)({
      max: result.max,
...
unwrapExports(fluidScroller);
var fluidScroller_1 = fluidScroller.getPixelThresholds;
var fluidScroller_2 = fluidScroller.config;

var jumpScroller = createCommonjsModule(function (module, exports) {
...
exports.default = function (_ref) {
  ...
  var moveByOffset = function moveByOffset(state, offset) {
    ...
    var client = (0, position.add)(drag.current.client.selection, offset);
    move(drag.initial.descriptor.id, client, (0, _getWindowScroll2.default)(), true);
  };

  var scrollDroppableAsMuchAsItCan = function scrollDroppableAsMuchAsItCan(droppable, change) {
    if (!(0, canScroll.canScrollDroppable)(droppable, change)) {
      return change;
    }

    var overlap = (0, canScroll.getDroppableOverlap)(droppable, change);
    ...
    var whatTheDroppableCanScroll = (0, position.subtract)(change, overlap);
    scrollDroppable(droppable.descriptor.id, whatTheDroppableCanScroll);

    var remainder = (0, position.subtract)(change, whatTheDroppableCanScroll);
    return remainder;
  };

  var scrollWindowAsMuchAsItCan = function scrollWindowAsMuchAsItCan(change) {
    if (!(0, canScroll.canScrollWindow)(change)) {
      return change;
    }

    var overlap = (0, canScroll.getWindowOverlap)(change);
    ...
    var whatTheWindowCanScroll = (0, position.subtract)(change, overlap);
    scrollWindow(whatTheWindowCanScroll);

    var remainder = (0, position.subtract)(change, whatTheWindowCanScroll);
    return remainder;
  };
...
unwrapExports(jumpScroller);

var autoScroller = createCommonjsModule(function (module, exports) {
...
var _fluidScroller2 = _interopRequireDefault(fluidScroller);



var _jumpScroller2 = _interopRequireDefault(jumpScroller);
...
var actionCreators_16 = actionCreators.bulkPublishDimensions;
var actionCreators_17 = actionCreators.publishDroppableDimension;
var actionCreators_18 = actionCreators.publishDraggableDimension;
var actionCreators_19 = actionCreators.completeLift;
var actionCreators_20 = actionCreators.requestDimensions;
...
var _hookCaller2 = _interopRequireDefault(hookCaller);
...
var _scrollWindow2 = _interopRequireDefault(scrollWindow);



var _announcer2 = _interopRequireDefault(announcer);



var _autoScroller2 = _interopRequireDefault(autoScroller);
    ...
    value: function componentWillMount() {
      ...
      var callbacks = {
        ...
        publishDraggable: function publishDraggable(dimension) {
          _this2.store.dispatch((0, actionCreators.publishDraggableDimension)(dimension));
        },
        publishDroppable: function publishDroppable(dimension) {
          _this2.store.dispatch((0, actionCreators.publishDroppableDimension)(dimension));
        },
        bulkPublish: function bulkPublish(droppables, draggables) {
          _this2.store.dispatch((0, actionCreators.bulkPublishDimensions)(droppables, draggables));
        },
      ...
      this.autoScroller = (0, _autoScroller2.default)({
        ...
        move: function move(id, client, windowScroll, shouldAnimate) {
          _this2.store.dispatch((0, actionCreators.move)(id, client, windowScroll, shouldAnimate));
        }
      });
...
var DroppableDimensionPublisher = function (_Component) {
  ...
  function DroppableDimensionPublisher(props, context) {
    ...
    _this.getDimension = function () {
      ...
      var dimension$$1 = (0, dimension.getDroppableDimension)({
        descriptor: descriptor,
        direction: direction,
        client: client,
        closest: closest,
...
Droppable.contextTypes = (0, _defineProperty3.default)({}, contextKeys.styleContextKey, _propTypes2.default.string.isRequired);
...
var DraggableDimensionPublisher = function (_Component) {
  ...
  function DraggableDimensionPublisher() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DraggableDimensionPublisher.__proto__ || (0, _getPrototypeOf2.default)(DraggableDimensionPublisher)).call.apply(_ref, [this].concat(args))), _this), _this.publishedDescriptor = null, _this.getMemoizedDescriptor = (0, _memoizeOne2.default)(function (id, droppableId, index) {
      ...
      var dimension$$1 = (0, dimension.getDraggableDimension)({
        descriptor: descriptor,
        client: client,
        margin: margin,
        windowScroll: (0, _getWindowScroll2.default)()
...
var keyCodes_5 = keyCodes.pageUp;
var keyCodes_6 = keyCodes.pageDown;
var keyCodes_7 = keyCodes.end;
var keyCodes_8 = keyCodes.home;
var keyCodes_9 = keyCodes.arrowLeft;
var keyCodes_10 = keyCodes.arrowUp;
var keyCodes_11 = keyCodes.arrowRight;
var keyCodes_12 = keyCodes.arrowDown;
...
var blocked = (_blocked = {}, (0, _defineProperty3.default)(_blocked, keyCodes$$1.enter, true), (0, _defineProperty3.default)(_blocked, keyCodes$$1.tab, true), _blocked);
...
var scrollJumpKeys = (_scrollJumpKeys = {}, (0, _defineProperty3.default)(_scrollJumpKeys, keyCodes$$1.pageDown, true), (0, _defineProperty3.default)(_scrollJumpKeys, keyCodes$$1.pageUp, true), (0, _defineProperty3.default)(_scrollJumpKeys, keyCodes$$1.home, true), (0, _defineProperty3.default)(_scrollJumpKeys, keyCodes$$1.end, true), _scrollJumpKeys);
...
exports.default = function (_ref) {
  ...
  var onKeyDown = function onKeyDown(event, props) {
    ...
    if (!isDragging()) {
      ...
      if (event.keyCode !== keyCodes$$1.space) {
        return;
      }
    ...
    if (event.keyCode === keyCodes$$1.arrowDown) {
      (0, _stopEvent2.default)(event);
    ...
    if (event.keyCode === keyCodes$$1.arrowUp) {
      (0, _stopEvent2.default)(event);
      executeBasedOnDirection({
    ...
    if (event.keyCode === keyCodes$$1.arrowRight) {
      (0, _stopEvent2.default)(event);
      executeBasedOnDirection({
    ...
    if (event.keyCode === keyCodes$$1.arrowLeft) {
      (0, _stopEvent2.default)(event);
      executeBasedOnDirection({
...
var index$18 = unwrapExports(lib$5);
